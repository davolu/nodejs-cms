import {
  ...
  PanelsTopLeft, GalleryHorizontal, Timer, Contrast, Code, FileCode, MapPin, CalendarClock, MessageSquare, UserRound, ShoppingBag, Blocks, Database, CreditCard, LogIn, FilePlus, LayoutGrid,
...
const NAME_ICON: Record<string, any> = {
  LogIn, FilePlus, LayoutGrid, Columns: Columns2,
