import {
  ...
  PanelsTopLeft, GalleryHorizontal, Timer, Contrast, Code, FileCode, MapPin, CalendarClock, MessageSquare, UserRound,
} from 'lucide-react'
...
export const CATEGORY_ORDER = ['Basic', 'Sections', 'Layout', 'Content', 'Media', 'Marketing', 'Forms', 'Members', 'Interactive', 'Embed', 'Social']
