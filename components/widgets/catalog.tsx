import {
  ...
  PanelsTopLeft, GalleryHorizontal, Timer, Contrast, Code, FileCode, MapPin, CalendarClock, MessageSquare, UserRound, ShoppingBag, Blocks, Database, CreditCard, LogIn, FilePlus, LayoutGrid, GitCommitHorizontal, Table, ChevronRight, ChevronDown, SquareArrowOutUpRight,
...
const NAME_ICON: Record<string, any> = {
  LogIn, FilePlus, LayoutGrid, GitCommitHorizontal, Table, ChevronRight, ChevronDown, SquareArrowOutUpRight, Columns: Columns2,
